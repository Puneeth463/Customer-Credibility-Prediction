...
def main():
    ...
    <h2 style="color:Black;text-align:center;">Customer Credibility Predictor App By Puneeth Nidamanuri </h2>
    </div>
    """
    ...
    st.success(result)
    st.subheader("Awesome Webapps by Puneeth Nidamanuri")
